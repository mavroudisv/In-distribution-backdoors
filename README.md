...
This repository contains the source code of sanitization backdoor policies for Atari breakout game environment. 
The backdoor policy in this example has been trained using the environment poisoning framework of TrojDRL [paper](https://arxiv.org/pdf/1903.06638.pdf) .
...
The latest version of the detection tool leaves here: https://github.com/alan-turing-institute/neural-watchdog
